...
На основании рекомендаций «Руководства Microsoft по проектированию архитектуры приложений» определены следующие ключевые показатели качества:
...
![](images/image_1.png)
Архитектура Money Flow построена по принципу разделения на слои (Layered Architecture), что соответствует рекомендациям из «Руководства Microsoft по моделированию приложений» и принципам Clean Architecture для Flutter:
**Слои приложения:**
